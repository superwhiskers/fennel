// libninty.c - test code for libninty.so
#include <stdio.h>
#include "libninty.h"
...
int main(int argc, char *argv[]) {
  ...
  Client client;
  client = libninty_newClient("https://account.nintendo.net/v1/api", "keypair/ctr-common-cert.pem", "keypair/ctr-common-key.pem", clientInfo);

  if (libninty_doesUserExist(client, argv[1]) == 0) {
